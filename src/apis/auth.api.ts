...
const authAPI = {
  ...
  register: (data: RegisterRequest) =>
    http.post<{ success: boolean; data: RegisterResponse; message: string }>('/auth/register', data),

  // Login
  login: (data: LoginRequest) =>
    http.post<{ success: boolean; data: AuthResponse['data']; message: string }>('/auth/login', data),

  // Refresh token
  refreshToken: (data: RefreshTokenRequest) =>
    http.post<{ success: boolean; data: AuthResponse['data']; message: string }>('/auth/refresh', data),
