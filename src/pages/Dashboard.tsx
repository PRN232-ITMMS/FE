...
import { Activity, Calendar, FileText, TrendingUp, Clock, CheckCircle2, AlertCircle, Users } from 'lucide-react'
      ...
      <div className='space-y-6 p-6'>
        ...
        <div className='space-y-2'>
          ...
          <p className='text-muted-foreground'>
            {profile.role === 1
              ? 'Theo dõi tiến trình điều trị và quản lý lịch hẹn của bạn'
              : profile.role === 2
