  ...
  return (
    <div className='flex min-h-screen items-center justify-center bg-background px-4'>
      <div className='text-center'>
        ...
        <h1 className='mt-6 text-3xl font-bold text-foreground'>Không có quyền truy cập</h1>

        <p className='mt-4 text-lg text-muted-foreground'>Bạn không có quyền truy cập vào trang này</p>
